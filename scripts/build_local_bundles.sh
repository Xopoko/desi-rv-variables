...
strict_candidates_url="${DESI_RV_STRICT_CANDIDATES_URL:-https://github.com/Xopoko/desi-rv-variables/releases/download/v0.1.2/candidate_sources_strict.csv.gz}"
